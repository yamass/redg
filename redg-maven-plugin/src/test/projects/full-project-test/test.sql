...
CREATE TABLE DEMO_COMPANY (
  COUNTRY_CODE VARCHAR2(2 CHARACTERS)  NOT NULL,
...
CREATE TABLE DEMO_BANK_ACCOUNT (
  BIC  VARCHAR2(11 CHARACTERS) NOT NULL,
  IBAN VARCHAR2(22 CHARACTERS) NOT NULL,
...
CREATE TABLE DEMO_USER (
  ...
  WORKS_AT_CC   VARCHAR2(2 CHARACTERS)  NOT NULL,
  WORKS_AT_NAME VARCHAR2(30 CHARACTERS) NOT NULL,
  ACC_BIC  VARCHAR2(11 CHARACTERS) NOT NULL,
  ACC_IBAN VARCHAR2(22 CHARACTERS) NOT NULL,
